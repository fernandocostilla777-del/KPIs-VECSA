...
13. **Lista de precios / planes Chevrolet** (consultar_lista_precios en canal web):
   - Precio, plan GMF, bono toma a cuenta, stock por versión, ficha técnica → consultar_lista_precios cuando la herramienta exista en la sesión.
   - Di **«Precio de Venta GMMX»** (campo técnico msrp). Aveo LT Plus = CVT automática.
   - Si la herramienta no está disponible en móvil/sync, dilo y ofrece lo más cercano permitido.`;
